...
selectStmtLineTest.prototype.ReturnCorrectselectStmtLine = function() {
	...
	tls.data[0].text = "\000";
	tls.data[0].tt = parseInt(konoha.ktoken_t.TK_INDENT);
	tls.data[0].kw = 0;
	tls.data[1] = new konoha.kToken();
	tls.data[1].text = "1";
	tls.data[1].tt = parseInt(konoha.ktoken_t.TK_INT);
	tls.data[1].kw = 0;
	tls.data[2] = new konoha.kToken();
	tls.data[2].text = "+";
	tls.data[2].tt = parseInt(konoha.ktoken_t.TK_OPERATOR);
	tls.data[2].kw = 0;
	tls.data[3] = new konoha.kToken();
	tls.data[3].text = "2";
	tls.data[3].tt = parseInt(konoha.ktoken_t.TK_INT);
	tls.data[3].kw = 0;
