...
KonohaSpace_tokenizeTest.prototype.ReturnCorrectTokens = function() {
	...
	expectEq("c", a.data[5].text.text);
	expectEq(konoha.ktoken_t.TK_OPERATOR, a.data[6].tt);
	expectEq("/", a.data[6].text.text);
	expectEq(konoha.ktoken_t.AST_PARENTHESIS, a.data[7].tt);
	expectEq("(", a.data[7].text.text);
	expectEq(konoha.ktoken_t.TK_SYMBOL, a.data[8].tt);
	expectEq("b", a.data[8].text.text);
	expectEq(konoha.ktoken_t.TK_OPERATOR, a.data[9].tt);
	expectEq("+", a.data[9].text.text);
	expectEq(konoha.ktoken_t.TK_SYMBOL, a.data[10].tt);
	expectEq("d", a.data[10].text.text);
